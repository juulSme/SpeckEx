...
speck64_128 = key128 |> Block.speck64_128_init!()
...
%{
  ...
  "Blowfish block enc" => [fn -> :crypto.crypto_update(blowfish_e, block128) end, tasks: tasks],
  ...
  "Blowfish block dec" => [fn -> :crypto.crypto_update(blowfish_d, block128) end, tasks: tasks],
  "AES 128/256 CTR enc" => [
